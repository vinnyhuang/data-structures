describe('tree', function() {
  ...
  it('should set parent property to children properly', function() {
    tree.addChild(5);
    tree.children[0].addChild(6);
  ...
  it('should remove parent properly', function() {
    tree.addChild(5);
    tree.children[0].addChild(6);
    var six = tree.children[0].children[0];
    six.removeFromParent();
    expect(tree.children[0].children[0]).to.equal(undefined);
    expect(six.parent).to.equal(null);
  });
